	...
	public static List<NewsSpikeRelationPrediction> predict(String input_model, List<Tuple> input_test) {
		...
		dr.close();
			...
			if (scorer.size() > 0) {
                                ...
                                String verbName = t.getVerb();                                 
                                String verbHead = t.getVerbHead();                                                                 
				...
				//}                              
                                ...
                                Argument verbPhrase = new Argument(verbName, t.v[0]+sentenceStartToken, t.v[1]+sentenceStartToken);                            
                                Argument verb = new Argument(verbHead, t.v[2]+sentenceStartToken, t.v[2]+sentenceStartToken);                            
				...
				//String relation = "";
                                ...
                                //System.out.println("NSPKB: " + arg1Type + ", " + arg2Type);                                                                
                                //System.out.println("NSPkb relation: " + relation);

                          	NewsSpikeRelationPrediction rp = new NewsSpikeRelationPrediction(verbPhrase,verb,arg1,arg2,arg1Type,arg2Type,relation,0,confidence);
				predictions.add(rp);
